...
contract InitializableMixinResolver is InitializableOwned {
    ...
    function _initializeMixinResolver(address _resolver, bytes32[MAX_ADDRESSES_FROM_RESOLVER] memory _addressesToCache)
        internal
        initializer
    {
